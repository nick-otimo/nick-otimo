...
// Replace this with a valid TikTok icon or custom SVG if needed
const TiktokIcon = () => (
  <svg className="w-5 h-5" viewBox="0 0 48 48" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    <path d="M33.25 6H28v20.563c0 3.888-3.149 7.045-7.037 7.045s-7.037-3.157-7.037-7.045c0-3.888 3.149-7.045 7.037-7.045.651 0 1.276.09 1.872.25v-4.986a12.02 12.02 0 00-1.872-.146c-6.627 0-12 5.373-12 12s5.373 12 12 12 12-5.373 12-12V17.03c1.518 1.13 3.45 1.798 5.5 1.798v-4.987c-3.037 0-5.5-2.462-5.5-5.5z" />
  </svg>
);
